...
@section('content')
    <div class="flex flex-wrap items-start justify-between gap-4 mb-6">
        ...
        <a href="{{ route('gestion-academica-cup.notas.show', $nota) }}" class="btn btn-outline shrink-0">Volver</a>
    </div>
    ...
    <x-card title="Formulario de edicion">
        <form method="POST" action="{{ route('gestion-academica-cup.notas.update', $nota) }}" class="app-form">
            ...
            <section class="app-form-section">
                ...
                <div class="app-form-grid cols-2">
                    <label class="form-control">
                        ...
                        <input type="number" name="nota" value="{{ old('nota', $nota->nota) }}" min="0" max="100" step="0.01" class="input input-bordered w-full" required>
                    </label>
                    <label class="form-control md:col-span-2">
                        <span class="label-text">Observacion</span>
                        <textarea name="observacion" class="textarea textarea-bordered w-full">{{ old('observacion', $nota->observacion) }}</textarea>
                    </label>
                </div>
            </section>
            ...
            <div class="app-form-actions flex flex-wrap gap-2">
                ...
                <a href="{{ route('gestion-academica-cup.notas.show', $nota) }}" class="btn btn-outline w-full sm:w-auto">Volver</a>
            </div>
        </form>
    </x-card>
@endsection
