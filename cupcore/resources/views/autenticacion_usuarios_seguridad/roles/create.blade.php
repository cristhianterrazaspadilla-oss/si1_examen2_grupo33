...
@section('title', 'CU3 Administrar Usuarios y Roles | Nuevo Rol')

@section('content')
    <x-page-title title="Nuevo Rol" subtitle="CU3 Administrar Usuarios y Roles" />
    ...
    <x-card title="Formulario de rol">
        <form method="POST" action="{{ route('autenticacion-usuarios-seguridad.roles.store') }}" class="app-form">
            @csrf
            ...
            <div class="app-form-actions">
                ...
                <a href="{{ route('autenticacion-usuarios-seguridad.roles.index') }}" class="btn btn-outline">Cancelar</a>
            </div>
        </form>
    </x-card>
@endsection
