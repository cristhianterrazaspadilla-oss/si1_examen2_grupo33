            ...
            <section class="app-form-section">
                ...
                <div class="app-form-grid cols-2">
                    <label class="form-control">
                        ...
                        <input type="text" name="ci" value="{{ old('ci') }}" class="input input-bordered" required>
                    </label>
                    <label class="form-control">
                        <span class="label-text">Correo</span>
                        <input type="email" name="correo" value="{{ old('correo') }}" class="input input-bordered">
                    </label>
                    <label class="form-control">
                        <span class="label-text">Nombres</span>
                        <input type="text" name="nombres" value="{{ old('nombres') }}" class="input input-bordered" required>
                    </label>
                    <label class="form-control">
                        <span class="label-text">Apellidos</span>
                        <input type="text" name="apellidos" value="{{ old('apellidos') }}" class="input input-bordered" required>
                    </label>
                    <label class="form-control md:col-span-2">
                        <span class="label-text">Telefono</span>
                        <input type="text" name="telefono" value="{{ old('telefono') }}" class="input input-bordered">
                    </label>
                </div>
            </section>
            ...
            <section class="app-form-section">
                ...
                <div class="app-form-grid cols-2">
                    <label class="form-control">
                        ...
                        <input type="text" name="profesion" value="{{ old('profesion') }}" class="input input-bordered">
                    </label>
                    <label class="form-control">
                        <span class="label-text">Especialidad</span>
                        <input type="text" name="especialidad" value="{{ old('especialidad') }}" class="input input-bordered">
                    </label>
