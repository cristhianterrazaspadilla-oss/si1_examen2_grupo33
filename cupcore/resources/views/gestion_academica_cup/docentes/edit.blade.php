            ...
            <section class="app-form-section">
                ...
                <div class="app-form-grid cols-2">
                    <label class="form-control">
                        ...
                        <input type="text" name="ci" value="{{ old('ci', $docente->ci) }}" class="input input-bordered" required>
                    </label>
                    <label class="form-control">
                        <span class="label-text">Correo</span>
                        <input type="email" name="correo" value="{{ old('correo', $docente->correo) }}" class="input input-bordered">
                    </label>
                    <label class="form-control">
                        <span class="label-text">Nombres</span>
                        <input type="text" name="nombres" value="{{ old('nombres', $docente->nombres) }}" class="input input-bordered" required>
                    </label>
                    <label class="form-control">
                        <span class="label-text">Apellidos</span>
                        <input type="text" name="apellidos" value="{{ old('apellidos', $docente->apellidos) }}" class="input input-bordered" required>
                    </label>
                    <label class="form-control md:col-span-2">
                        <span class="label-text">Telefono</span>
                        <input type="text" name="telefono" value="{{ old('telefono', $docente->telefono) }}" class="input input-bordered">
                    </label>
                </div>
            </section>
            ...
            <section class="app-form-section">
                ...
                <div class="app-form-grid cols-2">
                    <label class="form-control">
                        ...
                        <input type="text" name="profesion" value="{{ old('profesion', $docente->profesion) }}" class="input input-bordered">
                    </label>
                    <label class="form-control">
                        <span class="label-text">Especialidad</span>
                        <input type="text" name="especialidad" value="{{ old('especialidad', $docente->especialidad) }}" class="input input-bordered">
                    </label>
                    <label class="label cursor-pointer justify-start gap-3 rounded-2xl border border-blue-300/10 bg-slate-950/35 px-4 py-4">
                        ...
                        <span class="label-text">Tiene maestria</span>
                    </label>
                    <label class="label cursor-pointer justify-start gap-3 rounded-2xl border border-blue-300/10 bg-slate-950/35 px-4 py-4">
                        ...
                        <span class="label-text">Tiene diplomado</span>
                    </label>
                </div>
            </section>
