...
class AsistenciaDocenteController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('gestion_docente_evaluacion.asistencias_docentes.index', [
    ...
    {
        return view('gestion_docente_evaluacion.asistencias_docentes.create', [
    ...
    public function show(AsistenciaDocente $asistenciaDocente): View
    {
        ...
        return view('gestion_docente_evaluacion.asistencias_docentes.show', [
    ...
    public function edit(AsistenciaDocente $asistenciaDocente): View
    {
        ...
        return view('gestion_docente_evaluacion.asistencias_docentes.edit', [
            'asistencia' => $asistenciaDocente,
